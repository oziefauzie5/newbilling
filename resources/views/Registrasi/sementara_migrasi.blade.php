           ...
           <form class="form-horizontal"action="{{route('admin.reg.store_sementara_migrasi')}}" method="POST">
             ...
             <h3 class="mt-3 text-bolt">PELANGGAN</h3><hr>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control" id="layanan" name="reg_layanan" required >
              ...
              <div class="col-sm-4">
                <input type="text" id="tampil_username" name="reg_username" class="form-control hotspot" value="{{ Session::get('reg_username') }}"  >
              </div>
