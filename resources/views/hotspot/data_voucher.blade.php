  ...
  <div class="page-inner">
    <div class="col-md-12">
      ...
      <div class="card-header">
									<div class="card-title">STOK VOUCHER</div>
								</div>
        <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-3">
                      <a href="{{route('admin.vhc.data_pesanan')}}"><button class="btn btn-primary btn-sm mb-3 btn-block" type="button" >Data Pesanan</button></a>
                  </div>
                  <div class="col-3">
                      <a href="{{route('admin.vhc.voucher_terjual')}}"><button class="btn btn-primary btn-sm mb-3 btn-block" type="button" >Voucher Terjual</button></a>
                  </div>
                  <div class="col-3">
                      <a href="{{route('admin.vhc.update_voucher')}}"><button class="btn btn-primary btn-sm mb-3 btn-block" type="button" >Update Voucher</button></a>
                  </div>
                </div>
                  <hr>
                  <form >
            ...
            <table id="" class="display table text-nowrap" >                          
                <thead>
                    ...
                    @foreach ($data_voucher as $d)
                        <tr>
                            <td class="href_voucher_terjual" data-id="{{$d->vhc_username}}">{{$d->vhc_id}}</td>
