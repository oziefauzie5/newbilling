          ...
          <div class="card-body">
            ...
            <div class="form-group row div_ont"  style="display:none;" >
              ...
              <div class="form-group row div_tiket_topologi"  style="display:none;" >
                ...
                <div class="col-sm-4 notif">
                <input name="tiket_pop" id="tiket_pop" class="form-control readonly" value="">
              </div>
              <label class="col-sm-2 col-form-label">OLT</label>
              <div class="col-sm-4 notif">
                <input name="tiket_olt" id="tiket_olt" class="form-control readonly" value="">
                </div>
              </div>
              ...
              <div class="form-group row div_tiket_topologi"  style="display:none;" >
                ...
                <div class="col-sm-4 notif">
                <input name="tiket_odc" id="tiket_odc" class="form-control readonly" value="">
              </div>
              <label class="col-sm-2 col-form-label">ODP</label>
              <div class="col-sm-4 notif_valtiket">
                  <input name="tiket_odp" id="tiket_odp" class="form-control"  value="">
                  <div id="pesan"></div>
                </div>
              </div>
              @else
...
NAME : {{ strtoupper($tiket->input_nama) }}
...
ACTIVATION : {{strtoupper($antrian->tiket_nama)}}

@elseif($antrian->tiket_jenis == 'Reaktivasi')
ACTIVATION : {{strtoupper($antrian->tiket_nama)}}

@else
MAINTENANCE : {{strtoupper($antrian->tiket_nama)}}
@endif
@endforeach
                </textarea>
                </div>
