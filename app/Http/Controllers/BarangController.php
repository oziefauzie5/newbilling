...
use App\Models\Setting\SettingAplikasi;
...
class BarangController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('master/barang/barang', $data);
    }
    public function sub_barang($id)
    {
        ...
        return view('master/barang/sub_barang', $data);
    }
    ...
    public function rekap_barang($id)
    {
        ...
        // dd($hitung);
        // return view('master/barang/rekap_barang', $data);
        $pdf = App::make('dompdf.wrapper');
        $html = view('master/barang/rekap_barang', $data)->render();
    $pdf->loadHTML($html);
    ...
    public function store(Request $request)
    {
        ...
        for($x=0;$x<$request->qty;$x++){
            $units[] = [
                ...
                "subbarang_nama" => $request->barang_nama,
                "subbarang_qty" => $qty,
                "subbarang_keluar" => '0',
                "subbarang_stok" => $qty,
