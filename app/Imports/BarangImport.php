   ...
   public function model(array $row)
    {
        return new Data_Barang([
            ...
            'barang_rusak' =>$row[11],
            'barang_pengembalian' =>$row[12],
            'barang_hilang' =>$row[13],
            'barang_satuan' =>$row[14],
            'barang_sn' =>$row[15],
            'barang_mac' =>$row[16],
            'barang_mac_olt' =>$row[17],
            'barang_tglmasuk' =>$row[18],
            'barang_harga' =>$row[19],
            'barang_harga_satuan' =>$row[20],
            'barang_status' =>$row[21],
            'barang_img' =>$row[22],
            'barang_ket' =>$row[23],
            'barang_nama_pengguna' =>$row[24],
            'barang_admin_update' =>$row[25],
